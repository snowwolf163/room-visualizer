export default function GuidePage() {
  return (
    <div className="min-h-full bg-white max-w-4xl mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Guide</h1>
        <p className="text-muted-foreground mt-2">
          This tool visualizes room schedules from an Excel file. To work correctly, your file must
          include the required columns and valid schedule data.
        </p>
      </div>
      ...
      <section className="space-y-3">
        ...
        <p>
          Your Excel file must include a header row with these column names somewhere in the sheet:
        </p>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Start Date</strong> and <strong>End Date</strong>: the full date range for the course
          </li>
          <li>
            <strong>Days Met</strong>: meeting days such as <code>M (Monday)</code>, <code>T (Tuesday)</code>, <code>W (Wednesday)</code>, <code>R (Thursday)</code>,{" "}
            <code>F (Friday)</code>, <code>S (Saturday)</code>, <code>U (Sunday)</code>
          </li>
          <li>
            <strong>Start Time</strong> and <strong>End Time</strong>: class meeting times
          </li>
          <li>
      ...
      <section className="space-y-3">
        ...
        <p>
          The tool supports both normal text values and native Excel date/time cells.
        </p>

        <ul className="list-disc pl-6 space-y-2">
          <li>
            Text examples: <code>1/12/2026</code>, <code>5/8/2026</code>, <code>8:00 AM</code>,{" "}
            <code>1:50 PM</code>
          </li>
          <li>
            Excel date/time cells are also supported, so you do not need to convert them manually
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>No header row</strong>: the first row must contain column names, not data
          </li>
          <li>
            <strong>Wrong header names</strong>: required headers must match the expected names
          </li>
          <li>
            <strong>Missing Start Date or End Date</strong>: the app needs a date range to generate schedule blocks
          </li>
          <li>
            <strong>Missing Room</strong>: rows without a room are skipped
          </li>
          <li>
            <strong>Missing Days or Times</strong>: rows without meeting days or times cannot be displayed
          </li>
          <li>
            <strong>Different export format</strong>: some school exports omit required fields or rename columns
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Rows missing <strong>Room</strong>, <strong>Start Date</strong>, <strong>End Date</strong>,{" "}
            <strong>Start Time</strong>, or <strong>End Time</strong> will be ignored
          </li>
          <li>
            Column order does not matter, as long as the required headers are present
          </li>
          <li>
            Extra columns are okay and will be ignored
          </li>
          <li>
            The app reads the first worksheet in the uploaded Excel file
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Download a sample Excel file with the correct structure:
        </p>
        <a
